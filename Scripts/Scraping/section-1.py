...
droppedLinks = []
leaderboard = []
for i in range(4,26):	#Get all links of the leaderboard pages for section-1;Rank 600 to 5200
...
for oneRankList in leaderboard:	#For each page of the 25 pages
	...
	for user in (firstRandomUser,secondRandomUser):
		...
		os.mkdir("/home/chittaranjan/Documents/3rd Year/5_DA/Project/Section-1/"+username) #CHANGE THIS AS PER YOUR DIRECTORY STRUCTURE
