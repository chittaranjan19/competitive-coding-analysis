...
droppedLinks = []
leaderboard = []
for i in range(38,56):	#Get all links of the leaderboard pages for section-2.
...
for oneRankList in leaderboard:	#For each page of the 25 pages
	...
	for user in (firstRandomUser,secondRandomUser):
		...
		os.mkdir("/home/vishal/Documents/5th sem/DA/Project/Section-2/"+username) #CHANGE THIS AS PER YOUR DIRECTORY STRUCTURE
